...
func (_m *AccountsStore) AddClan(serverKey string, clan models.Clan) error {
	ret := _m.Called(serverKey, clan)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, models.Clan) error); ok {
...
func (_m *AccountsStore) AddServer(snowflake string, server models.AccountServer) error {
	ret := _m.Called(snowflake, server)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, models.AccountServer) error); ok {
...
func (_m *AccountsStore) All(_a0 *[]models.Account) error {
	ret := _m.Called(_a0)
...
func (_m *AccountsStore) GetByDiscordGuild(snowflake string) (models.Account, error) {
...
func (_m *AccountsStore) GetByServerKey(serverKey string) (models.Account, error) {
...
func (_m *AccountsStore) RemoveNotInDiscordGuildList(guildIDs []models.BaseAccount) error {
	ret := _m.Called(guildIDs)

	var r0 error
	if rf, ok := ret.Get(0).(func([]models.BaseAccount) error); ok {
		r0 = rf(guildIDs)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *AccountsStore) SetClans(serverKey string, clans []models.Clan) error {
...
func (_m *AccountsStore) UpdateServer(snowflake string, oldKey string, server models.AccountServer) error {
	ret := _m.Called(snowflake, oldKey, server)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, models.AccountServer) error); ok {
...
func (_m *AccountsStore) UpsertBase(_a0 models.BaseAccount) error {
	ret := _m.Called(_a0)
