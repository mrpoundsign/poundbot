...
func (_m *DiscordAuthsStore) GetByDiscordID(snowflake string) (models.DiscordAuth, error) {
	ret := _m.Called(snowflake)

	var r0 models.DiscordAuth
	if rf, ok := ret.Get(0).(func(string) models.DiscordAuth); ok {
		r0 = rf(snowflake)
	} else {
		r0 = ret.Get(0).(models.DiscordAuth)
	}
...
func (_m *DiscordAuthsStore) GetByDiscordName(discordName string) (models.DiscordAuth, error) {
...
func (_m *DiscordAuthsStore) Upsert(_a0 models.DiscordAuth) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(models.DiscordAuth) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
